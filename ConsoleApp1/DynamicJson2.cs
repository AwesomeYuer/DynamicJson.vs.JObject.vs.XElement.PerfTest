...
namespace Microshaoft
{
    ...
    public partial class DynamicJson2 : DynamicObject
    {
        ...
        public DynamicJson2 this[string key]
        {
            get
            {
        ...
        public DynamicJson2 this[int index]
        {
            get
            {
                var x = xml
        ...
        private DynamicJson2 XElementToDynamicJson
                                (
                                    XElement x
                                    , out dynamic value
                                )
        ...
        {
            UNKNOWN ,@string, number, boolean, @object, array, @null
        }
        ...
        public static dynamic Parse(string json, Encoding encoding)
        {
            ...
            using
                (
                    XmlDictionaryReader xmlDictionaryReader = JsonReaderWriterFactory
                                            .CreateJsonReader
                                                    (
                                                        buffer
                                                        //encoding.
                ...
                )
            {
                ...
                var x = XElement.Load(xmlDictionaryReader);
                //var i = 0;
        ...
        private static dynamic ToValue(XElement element)
        {
            ...
            {
                s = element.Attribute("type").Value;
            }


            var type =  (JsonType)Enum.Parse(typeof(JsonType), s);
            switch (type)
            {
                ...
                case JsonType.array:
                    return new DynamicJson2(element, type);
                case JsonType.@null:
                default:
                    return null;
            }
        ...
        private DynamicJson2(XElement element, JsonType type)
        {
        ...
        private dynamic DeserializeValue(XElement element, Type elementType)
        {
            ...
            if (value is DynamicJson2)
            {
                value = ((DynamicJson2)value).Deserialize(elementType);
            }
